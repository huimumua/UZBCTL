/**
@file   zw_api_test.h - Z-wave HC API test header file.
...
Z-wave HC API test header file.
@{
*/
...
typedef struct _hl_appl_ctx
{
    ...
    uint8_t             command[5];                 ///< Command and parameters
    ...
    char			    *node_info_file;            ///< file name of the node information file
    char			    *save_file;                 ///< file name where the node information to be saved
    ...
    int                 dlg_ok;                     ///< Dialog button ok is depressed
...
INT_PTR CALLBACK    hl_setting_dlgbx(HWND, UINT, WPARAM, LPARAM);
INT_PTR CALLBACK    hl_stress_test_dlgbx(HWND, UINT, WPARAM, LPARAM);
...
INT_PTR CALLBACK    hl_init_dlgbx(HWND, UINT, WPARAM, LPARAM);
INT_PTR CALLBACK    hl_save_dlgbx(HWND, UINT, WPARAM, LPARAM);
